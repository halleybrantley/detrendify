...
\begin{description}
	...
	\item[R-package for detrend routine:] R-package detrendr containing code to perform the methods described in the article. (GNU zipped tar file also available at https://github.com/halleybrantley/detrendr)
