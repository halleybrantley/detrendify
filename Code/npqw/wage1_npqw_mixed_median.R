## $Id: wage1_npqw_mixed_median.R,v 1.3 2014/10/09 19:33:16 jracine Exp jracine $

source("lib_npqw_mixed.R")

pdf(file="wage1_median.pdf")
...
## values of delta and the bandwidths.  Note that the liracine kernel
